...
public class SMS extends AppCompatActivity {
    ...
    private void sos(){
        ...
        sendSMS(phoneNum, "Hi, I am in trouble, please help me by reaching to Ramnagar,Bhosari,Pimpri-chinchawad. My Location: " + url );
    }

    private MyLatLng getMyLatLang(){
        gpsTracker = new GpsTracker(SMS.this);
